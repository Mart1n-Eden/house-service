...
// FlatService is an autogenerated mock type for the FlatService type
type FlatService struct {
	mock.Mock
}

// CreateFlat provides a mock function with given fields: ctx, houseId, price, rooms
func (_m *FlatService) CreateFlat(ctx context.Context, houseId int, price int, rooms int) (*domain.Flat, error) {
...
func (_m *FlatService) GetHouse(ctx context.Context, id int) ([]domain.Flat, error) {
...
func (_m *FlatService) UpdateFlat(ctx context.Context, id int, status string) (*domain.Flat, error) {
...
// NewFlatService creates a new instance of FlatService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewFlatService(t interface {
	mock.TestingT
	Cleanup(func())
}) *FlatService {
	mock := &FlatService{}
